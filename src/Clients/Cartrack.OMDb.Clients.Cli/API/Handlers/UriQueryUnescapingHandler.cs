...
namespace Cartrack.OMDb.Clients.Cli.API.Handlers
{
    /// <summary>
    ...
    {
        public UriQueryUnescapingHandler() : base(new HttpClientHandler()) 
        {

        }
        public UriQueryUnescapingHandler(HttpMessageHandler innerHandler) : base(innerHandler)
        { 
